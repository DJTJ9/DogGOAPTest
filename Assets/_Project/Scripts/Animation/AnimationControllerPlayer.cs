...
public class AnimationControllerPlayer : MonoBehaviour
{
    ...
    [HideInInspector]
    public int deathBoolHash = Animator.StringToHash("isDead");

    [HideInInspector]
    public int isKickingHash = Animator.StringToHash("isKicking");

    [HideInInspector]
    public int isPunchingLeftHash = Animator.StringToHash("isPunching_Left");

    [HideInInspector]
    public int isPunchingRightHash = Animator.StringToHash("isPunching_Right");

    [HideInInspector]
    public int isWavingHash = Animator.StringToHash("isWaving");

    [HideInInspector]
    public int isTextingHash = Animator.StringToHash("isTexting");

    [HideInInspector]
    public int isThrowingHash = Animator.StringToHash("isThrowing");
