...
public class GoapAgent : MonoBehaviour
{
    ...
    void SetupBeliefs() {
        ...
        factory.AddLocationBelief(Beliefs.DogAtFoodBowl, 2.2f, knownLocations.FoodBowl);
        factory.AddLocationBelief(Beliefs.DogAtWaterBowl, 2.2f, knownLocations.WaterBowl);
    ...
    protected virtual void SetupAndUpdateActions() {
        ...
        actions.Add(new AgentAction.Builder(ActionType.MoveToEatingPosition)
            .WithStrategy(new MoveStrategy(navMeshAgent, () => knownLocations.FoodBowl.position, dog.Settings.pickUpDistance))
            .AddEffect(beliefs[Beliefs.DogAtFoodBowl])
            .Build());

        actions.Add(new AgentAction.Builder(ActionType.Eat)
            .WithStrategy(new EatStrategy(animations, knownLocations.FoodBowl, dog))
        ...
        actions.Add(new AgentAction.Builder(ActionType.MoveToDrinkingPosition)
            .WithStrategy(new MoveStrategy(navMeshAgent, () => knownLocations.WaterBowl.position, dog.Settings.pickUpDistance))
            .AddEffect(beliefs[Beliefs.DogAtWaterBowl])
            .Build());

        actions.Add(new AgentAction.Builder(ActionType.Drink)
            .WithStrategy(new DrinkStrategy(animations, knownLocations.WaterBowl, dog))
